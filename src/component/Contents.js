    ...
    <div className={sss.content}>
      ...
      <div className={sss.maindesc2}>
        <p>
          ...
          CALIVERSE. Holding a CALIVERSE Pioneer Collective NFT
          <br />
      ...
      <div className={sss.schedule}>
        <p className={sss.schedule_title1}>MINTING EVENT SCHEDULE</p>
        <p className={sss.schedule_title2}>Minting Event Schedule</p>
        <div className={sss.date}>
          <p className={sss.datetext}>
            시작{" "}
            <span style={{ color: "#8E8E8E", padding: "6px" }}>
              2024년 9월 23일 (월) 17:00 (KST)
            </span>
          </p>
          <p className={sss.datetext}>
            종료{" "}
            <span style={{ color: "#8E8E8E", padding: "5px" }}>
              2024년 12월 23일 (월) 17:00 (KST)
            </span>
          </p>
        </div>
      ...
      <div className={sss.box}>
        <div className={sss.qkdqjq_box}>
          <p className={sss.qkdqjq}>
            <span>
              CALIVERSE PIONEER NFT <br className={sss.change2line} />
              민팅 참여방법
            </span>
          </p>
        </div>
        ...
        <div className={sss.dlrjs}>
          <div className={sss.module_border_wrap}>
            <div className={sss.module}>
              <p className={sss.ckarkwkrur_title}>참가자격</p>
              <p className={sss.module_text1}>
                CALIVERSE Pioneer NFT 민팅 이벤트는 당첨자만 참여하실 수
                있습니다.
              </p>
              <p className={sss.module_text2}>
                These portraits encapsulate the spirit of those trailblazers who
                constantly seek new possibilities, never content with the
                present.
              </p>
            </div>
          </div>
