    ...
    <>
      <div className={bbb.boxcontainer}>
        <div className={bbb.gadna}>
          <div className={bbb.boxes}>
            <div className={bbb.icon_text}>
              <img className={bbb.icon} src={icon1} />
              <div className={bbb.titledesc1}>
                <div className={bbb.title}>
                  <p>SIGN IN & VERIFY</p>
                </div>
                <div className={bbb.desc_}>
                  <div className={bbb.desc1}>
                    <p>회원 가입 후 당첨된 지갑 주소를 연결해 주세요.</p>
                  </div>
                  <div>
                    <p className={bbb.desc2}>
                      민팅 시 가스비가 발생됩니다. 충분한 이더{"(ETH)"}를 넣은
                      후 민팅을 진행해 주세요.
                    </p>
                  </div>
                </div>
          ...
          <div className={bbb.boxes}>
            <div className={bbb.icon_text}>
              ...
              <div className={bbb.titledesc1}>
                ...
                <div className={bbb.desc_}>
                  <div className={bbb.desc1}>
                    <p>Event Schedule을 확인해 주세요.</p>
                  </div>
                  <div className={bbb.desc2}>
                    <p>민팅 기간이 지나면 민팅이 불가하니 유의해 주세요</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className={bbb.boxes}>
            <div className={bbb.icon_text2}>
              <img className={bbb.icon2} src={icon3} />
              <div className={bbb.titledesc2}>
                <div className={bbb.title}>
                  <p>MINT</p>
                </div>
                <div className={bbb.desc_}>
                  <div className={bbb.ddd}>
                    <p>{"<Mint>"} 버튼을 클릭 후 민팅을 진행해 주세요.</p>
                  </div>
                </div>
              </div>
            </div>
